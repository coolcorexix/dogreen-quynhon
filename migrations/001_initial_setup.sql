...
-- This migration contains the original user checklist progress functionality
-- Created: Initial setup
-- Description: Basic user checklist progress tracking for 30-day environmental activities
